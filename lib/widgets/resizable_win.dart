                    ...
                    children: [
                      ...
                      TuFlex(
                        ...
                        children: [
                          ...(widget.trailing ?? []),
                          WindowCapBtn(
                            button: WindowCaptionButton.minimize,
                            onPressed: () {
                          ...
                          WindowCapBtn(
                            button: WindowCaptionButton.close,
                            onPressed: () {
                              windowManager.close();
                            },
                          ),
...
class WindowCapBtn extends StatelessWidget {
  final Function(
      {Brightness? brightness,
      Widget? icon,
      Key? key,
      void Function()? onPressed}) button;

  final void Function()? onPressed;
  const WindowCapBtn({super.key, required this.button, this.onPressed});

  @override
  Widget build(BuildContext context) {
    return Obx(() => button(
        brightness: Tu.appCtrl.darkMode ? Brightness.dark : Brightness.light,
        onPressed: onPressed));
  }
}
